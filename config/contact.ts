...
export const contactConfig = {
  company: {
    name: process.env.NEXT_PUBLIC_COMPANY_NAME || "Cartify",
    email: process.env.NEXT_PUBLIC_COMPANY_EMAIL || "support@Cartify.com",
  ...
  emails: {
    support: process.env.NEXT_PUBLIC_SUPPORT_EMAIL || "support@Cartify.com",
    sales: process.env.NEXT_PUBLIC_SALES_EMAIL || "sales@Cartify.com",
  },
  responseTime: {
    standard:
