...
const BASE_URL = "https://Cartifypro.reactbd.org";
...
export function generateCategoryMetadata(
  ...
  const description =
    ...
    `Browse ${productCount} products in ${title} category at Cartify. Find the best deals and quality items.`;
...
export function generateProductSchema(product: any) {
  ...
  // Extract brand name if it's populated
  const brandName =
    typeof product.brand === "object" ? product.brand?.name : "Cartify";
...
export function generateOrganizationSchema() {
  return {
    ...
    sameAs: [
      "https://facebook.com/Cartify",
      "https://twitter.com/Cartify",
      "https://instagram.com/Cartify",
      "https://linkedin.com/company/Cartify",
    ],
  };
}
...
export function generateHomeMetadata(): Metadata {
  return {
    title: "Cartify - Your Trusted Online Shopping Destination",
    description:
      "Discover amazing products at Cartify, your trusted online shopping destination for quality items and exceptional customer service. Shop electronics, fashion, home goods and more with fast delivery.",
    keywords: [
      "online shopping",
      "e-commerce",
      "buy online",
    ...
    openGraph: {
      ...
      title: "Cartify - Your Trusted Online Shopping Destination",
      description:
        "Discover amazing products at Cartify. Shop electronics, fashion, home goods and more with fast delivery.",
      images: [
        {
          url: "/og-image.jpg",
          width: 1200,
          height: 630,
          alt: "Cartify Online Store",
        },
      ],
    },
    twitter: {
      ...
      title: "Cartify - Your Trusted Online Shopping Destination",
      description:
        "Discover amazing products at Cartify. Shop electronics, fashion, home goods and more.",
      images: ["/og-image.jpg"],
    },
    alternates: {
      canonical: BASE_URL,
