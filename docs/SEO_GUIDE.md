# SEO Implementation Guide - Cartify

## Overview

This document outlines the comprehensive SEO implementation for Cartify e-commerce platform at **https://Cartifypro.reactbd.org**. The implementation follows modern SEO best practices and is optimized for Next.js 16.
...
- metadataBase: `https://Cartifypro.reactbd.org`
- Title template: `%s | Cartify - Premium Online Shopping`
...
export const metadata: Metadata = {
  metadataBase: new URL("https://Cartifypro.reactbd.org"),
  title: {
    template: "%s | Cartify - Premium Online Shopping",
    default: "Cartify - Your Trusted Online Shopping Destination",
  },
...
<script type="application/ld+json">
{
  ...
  "@type": "Organization",
  "name": "Cartify",
  "url": "https://Cartifypro.reactbd.org",
  // ...
}
</script>
```
...
**Example URL:** `https://Cartifypro.reactbd.org/product/iphone-15-pro`
...
**Example URL:** `https://Cartifypro.reactbd.org/category/electronics`
...
```json
{
  ...
  "offers": {
    "@type": "Offer",
    "url": "https://Cartifypro.reactbd.org/product/iphone-15-pro",
    "priceCurrency": "USD",
    "price": 999,
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "Home",
      "item": "https://Cartifypro.reactbd.org"
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "Shop",
      "item": "https://Cartifypro.reactbd.org/shop"
    }
  ]
}
```
...
```json
{
  ...
  "name": "Cartify",
  "url": "https://Cartifypro.reactbd.org",
  "logo": "https://Cartifypro.reactbd.org/logo.png",
  "contactPoint": {
    "@type": "ContactPoint",
    "telephone": "+1-555-123-4567",
    "contactType": "customer service"
  },
  "sameAs": ["https://facebook.com/Cartify", "https://twitter.com/Cartify"]
}
```
...
```json
{
  ...
  "potentialAction": {
    ...
    "target": {
      "@type": "EntryPoint",
      "urlTemplate": "https://Cartifypro.reactbd.org/shop?search={search_term_string}"
    },
...
**URL:** `https://Cartifypro.reactbd.org/sitemap.xml`
...
Sitemap: https://Cartifypro.reactbd.org/sitemap.xml
```

**URL:** `https://Cartifypro.reactbd.org/robots.txt`
...
```env
# Base URL for SEO
NEXT_PUBLIC_BASE_URL=https://Cartifypro.reactbd.org

# Google Search Console verification
GOOGLE_SITE_VERIFICATION=your-verification-code

# Company Information (used in schemas)
NEXT_PUBLIC_COMPANY_NAME=Cartify
NEXT_PUBLIC_COMPANY_EMAIL=support@Cartify.com
