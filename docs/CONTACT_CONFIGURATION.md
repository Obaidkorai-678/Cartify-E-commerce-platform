...
```bash
NEXT_PUBLIC_COMPANY_NAME=Cartify                          # Your company name
NEXT_PUBLIC_COMPANY_EMAIL=support@Cartify.com             # Main company email
...
```bash
NEXT_PUBLIC_SUPPORT_EMAIL=support@Cartify.com             # Customer support email
NEXT_PUBLIC_SALES_EMAIL=sales@Cartify.com                 # Sales team email
```
...
```bash
NEXT_PUBLIC_FACEBOOK_URL=https://facebook.com/Cartify
NEXT_PUBLIC_TWITTER_URL=https://twitter.com/Cartify
NEXT_PUBLIC_INSTAGRAM_URL=https://instagram.com/Cartify
NEXT_PUBLIC_LINKEDIN_URL=https://linkedin.com/company/Cartify
```

### Legal Pages

```bash
NEXT_PUBLIC_COPYRIGHT_TEXT=© 2024 Cartify. All rights reserved.
