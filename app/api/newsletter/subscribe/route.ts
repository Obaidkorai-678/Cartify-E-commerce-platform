...
export async function POST(request: NextRequest) {
  try {
    ...
    const emailResult = await sendMail({
      email,
      subject: "Welcome to Cartify Newsletter! 🎉",
...
<head>
    ...
    <title>Welcome to Cartify Newsletter</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="welcome-message">
                ...
                <p>
                    Thank you for subscribing to the Cartify newsletter! We're thrilled to have you as part of our community.
            ...
            <div class="cta-section">
                ...
                <a href="${
                  process.env.NEXT_PUBLIC_BASE_URL || "https://Cartify.com"
                }" class="cta-button">
                    Shop Now →
                </a>
            </div>
        ...
        <!-- Footer -->
        <div class="footer">
            <p><strong>Cartify</strong></p>
            <p>123 Shopping Street, Commerce District<br>
               New York, NY 10001, USA</p>
            <p>
                Questions? Contact us at
                <a href="mailto:support@Cartify.com">support@Cartify.com</a> or
            ...
            <div class="unsubscribe">
                <p>
                    You received this email because you subscribed to Cartify Newsletter with ${email}.<br>
                    <a href="${
                      process.env.NEXT_PUBLIC_BASE_URL ||
                      "https://Cartifypro.org"
