...
const socialLink = [
  {
    title: "Youtube",
    href: "https://www.youtube.com/@codebyObaid",
    icon: <Youtube className="w-5 h-5" />,
  },
  {
    title: "Github",
    href: "https://github.com/Obaidkorai-678",
    icon: <Github className="w-5 h-5" />,
  },
  {
    title: "Linkedin",
    href: "https://www.linkedin.com/in/obaid-korai-17380b3b8/",
    icon: <Linkedin className="w-5 h-5" />,
  },
  {
    title: "Facebook",
    href: "https://www.facebook.com/profile.php?id=61578155308266",
